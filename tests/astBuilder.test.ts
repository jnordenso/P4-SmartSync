...
Deno.test("AST Builder - Integration test - Function", () => {
    const testCases = [
                ...
                body: [
                    {
                        ...
                        parameters: [
                            { kind: "Parameter", line: 1, type: "Number", name: "a" },
                            { kind: "Parameter", line: 1, type: "Number", name: "b" },
                        ],
                        body: [
                            {
                                kind: "IfStm",
        ...
        }, */ // TODO: ITS currently not allowed to place RETURN anywhere except at the end of the function
    ];
